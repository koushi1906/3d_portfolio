    ...
    <section className="w-full h-screen relative">
      ...
      <Canvas className={`w-full h-screen bg-transparent ${isRotating ? 'cursor-grabbing' : 'cursor-grab'}`} camera={{near: 0.1, far: 1000}}>
        <Suspense fallback={<Loader />}>
          ...
          <Island position={islandPosition} scale={islandScale} rotation={islandRotation} isRotating={isRotating} setCurrentStage={setCurrentStage} setIsRotating={setIsRotating}/>
          <Plane scale={planeScale} position={planePosition} isRotating={isRotating} planeRotation={planeRotation} rotation={[0, 20, 0]}/>
        </Suspense>
      </Canvas>
